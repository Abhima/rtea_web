...
class CI_Googlemaps {
	...
	var $map_height					= "640px";					// The height of the map container. Any units (ie 'px') can be used. If no units are provided 'px' will be presumed
	var $map_name					= "map_two";					// The JS reference to the map. Currently not used but to be used in the future when multiple maps are supported
	...
	function add_marker($params = array())
	{
		...
		$marker['position'] = '$latitude, $longitude';								// The position (lat/long co-ordinate or address) at which the marker will appear
